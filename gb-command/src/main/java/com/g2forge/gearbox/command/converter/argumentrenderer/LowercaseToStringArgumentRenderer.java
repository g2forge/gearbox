...
public class LowercaseToStringArgumentRenderer extends ASimpleArgumentRenderer<Object> {
	@Override
	protected List<String> renderSimple(IMethodArgument<Object> argument) {
		return HDumbCommandConverter.computeString(argument, Objects.toString(argument.get()).toLowerCase());
	}
}
