...
public class TestDefaultMethodInvocationTransformer {
	public interface IDefaultModify extends ITestCommandInterface {
		public default int method() {
			throw new ModifyProcessInvocationException(processInvocation -> new ProcessInvocation<>(processInvocation.getCommandInvocation(), processInvocation.getCommandMetadata(), process -> 3));
		}
	}
